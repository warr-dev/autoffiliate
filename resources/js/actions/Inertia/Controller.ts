...
* @route '/create'
*/
const Controller356211b3240707e1cb39bee46a9a80aa = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller356211b3240707e1cb39bee46a9a80aa.url(options),
    method: 'get',
})

Controller356211b3240707e1cb39bee46a9a80aa.definition = {
    methods: ["get","head"],
    url: '/create',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/create'
*/
Controller356211b3240707e1cb39bee46a9a80aa.url = (options?: RouteQueryOptions) => {
    return Controller356211b3240707e1cb39bee46a9a80aa.definition.url + queryParams(options)
}
...
* @route '/create'
*/
Controller356211b3240707e1cb39bee46a9a80aa.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller356211b3240707e1cb39bee46a9a80aa.url(options),
    method: 'get',
})
...
* @route '/create'
*/
Controller356211b3240707e1cb39bee46a9a80aa.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller356211b3240707e1cb39bee46a9a80aa.url(options),
    method: 'head',
})
...
* @route '/create'
*/
const Controller356211b3240707e1cb39bee46a9a80aaForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller356211b3240707e1cb39bee46a9a80aa.url(options),
    method: 'get',
})
...
* @route '/create'
*/
Controller356211b3240707e1cb39bee46a9a80aaForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller356211b3240707e1cb39bee46a9a80aa.url(options),
    method: 'get',
})
...
* @route '/create'
*/
Controller356211b3240707e1cb39bee46a9a80aaForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller356211b3240707e1cb39bee46a9a80aa.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
Controller356211b3240707e1cb39bee46a9a80aa.form = Controller356211b3240707e1cb39bee46a9a80aaForm
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
...
const Controller = {
    ...
    '/create': Controller356211b3240707e1cb39bee46a9a80aa,

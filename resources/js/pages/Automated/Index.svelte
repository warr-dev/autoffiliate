<script lang="ts">
    ...
    let logStatusFilter = $state<'all' | 'SUCCESS' | 'FAILED' | 'RUNNING'>(
        'all',
    );
    ...
    async function testGeneratePreview() {
        if (selectedWorkflowActions.length === 0) {
            actionNotification =
                '⚠️ Please select at least 1 workflow action step before testing.';
        ...
        try {
            ...
            const hasMediaStep = selectedWorkflowActions.some((a) => {
                ...
                return (
                    l.includes('extract') ||
                    l.includes('shopee') ||
                    l.includes('product media')
                );
            });

            if (res.ok) {
                const data = await res.json();
                let sampleImg = hasMediaStep
                ...
                testPreviewResult = {
                    ...
                    image: sampleImg,
                    executedSteps:
                        data.executed_steps || selectedWorkflowActions,
                };
            } else {
    ...
    const availableTones = [
        {
            id: 'taglish',
            label: 'Taglish 🇵🇭',
            description: 'Natural Pinoy Taglish blend',
        },
        {
            id: 'casual',
            label: 'Casual 🤝',
        ...
        },
        {
            id: 'hype',
            label: 'Viral Hype 🔥',
            description: 'High energy and urgency',
        },
        {
            id: 'professional',
            label: 'Professional 👔',
            description: 'Clean polished tone',
        },
        {
            id: 'friendly',
            label: 'Friendly ☕',
        ...
        },
        {
            id: 'minimalist',
            label: 'Minimalist ⚡',
            description: 'Short 3-line bullet style',
        },
    ];
    ...
    const availablePersonas = [
        {
            id: 'storyteller',
            label: 'Storyteller Reviewer 📖',
            description: 'Relatable personal experience',
        },
        {
            id: 'tech_reviewer',
            label: 'Technical Reviewer 💻',
            description: 'Specs breakdown and expert buying tips',
        },
        {
            id: 'deal_hunter',
            label: 'Deal Hunter / Shopping Buddy 🛒',
            description: 'Urgent price callouts and voucher tips',
        },
        {
            id: 'community_host',
            label: 'Community Host 🎙️',
            description: 'Engages followers with check-in questions and polls',
        },
        {
            id: 'curator',
            label: 'Minimalist Curator 🎯',
    ...
    let canProceedToSubStep3_3 = $derived(
        selectedWorkflowActions.length > 0 ||
            manualCustomPrompt.trim().length > 0,
    );
    ...
    const presetWorkflows: WorkflowActionDefinition[] = [
        // General Purpose Content Parameters
        {
            ...
            docDescription:
                'Checks local time (Morning/Afternoon/Evening) and day of week (e.g. Happy Saturday!) to generate a warm, casual community check-in.',
            inputOutputDoc:
                'Input: Time & Date Context ➔ Output: Time & Day Appropriate Community Greeting.',
        ...
        },
        {
            ...
            docDescription:
                'Appends a local weather check-in callout (e.g., cozy rainy WFH vibes or hot sunny coffee break).',
            inputOutputDoc:
                'Input: Local Weather Vibe ➔ Output: Weather-Themed Lounge Callout.',
        ...
        },
        {
            ...
            docDescription:
                'Incorporate current occasion, holiday, or flash sale hooks (e.g., 8.8 Payday Sale, Weekend Lounge).',
            inputOutputDoc:
                'Input: Occasion Context ➔ Output: Occasion-Themed Post Hook.',
        ...
        },
        {
            ...
            docDescription:
                'Generates an interactive A/B product preference comparison caption that encourages community members to vote in the comments.',
            inputOutputDoc:
                'Input: Niche Context ➔ Output: Structured Poll Caption with Choice A vs Choice B callouts.',
            contextPlaceholder:
                'e.g. Compare Mechanical Keyboards vs Wireless Headphones',
        },
        {
            ...
            docDescription:
                'Appends a targeted community question or opinion callout to encourage fan comments and interaction.',
            inputOutputDoc:
                'Input: Discussion Context ➔ Output: Engaging Open Question Callout for Comments.',
            contextPlaceholder:
                'e.g. Ask fans what gadget they bought this month',
        },
        {
            id: 'value_tip',
            ...
            docDescription:
                'Creates a helpful reviewer-style caption breaking down product specs, features, and smart online buying tips.',
            inputOutputDoc:
                'Input: Shopping Niche Context ➔ Output: 3-line Pro Buying Advice Caption.',
            contextPlaceholder:
                'e.g. Highlight Shopee Payday Sale voucher stacking tips',
        },
        {
            id: 'brand_promo',
            ...
            docDescription:
                'Appends official brand discount voucher codes (e.g. "TECHDEALS100") and promo announcement text to the caption.',
            inputOutputDoc:
                'Input: Promo Voucher Code ➔ Output: Brand Voucher Announcement Caption.',
            contextPlaceholder:
                'e.g. Voucher ANKER88 for 20% OFF until midnight',
        },
        {
            id: 'hashtags',
            ...
            docDescription:
                'Combines your page’s default global hashtags (#TechSulitDeals #ShopeePH #BudolFinds) with custom niche tags.',
            inputOutputDoc:
                'Input: Post Tags ➔ Output: Formatted Hashtag Cluster.',
        ...
        },
        {
            ...
            docDescription:
                'Analyzes post title & caption text to automatically build relevant, trending hashtag clusters (#TechSulitDeals #WFHSetup #ShopeePH).',
            inputOutputDoc:
                'Input: Generated Title + Caption ➔ Output: Relevant Dynamic Hashtags Appended.',
        ...
        // Dedicated Affiliate Specific Actions
        {
            ...
            docDescription:
                'Scrapes Shopee item metadata (product title, high-res images, flash sale pricing) to feed exact product details into the affiliate engine.',
            inputOutputDoc:
                'Input: Shopee URL ➔ Output: Product Title, Clean Images, Price, and Affiliate Buy Link.',
        ...
        },
        {
            ...
            docDescription:
                'Composes a high-energy affiliate deal caption loaded with pricing callouts, discount urgency, and direct Shopee buy link CTA.',
            inputOutputDoc:
                'Input: Shopee Product Title + Price ➔ Output: High-Converting Affiliate Deal Caption.',
            contextPlaceholder:
                'e.g. Emphasize limited 50% OFF flash sale urgency',
        },
        {
            ...
            docDescription:
                'Appends official Shopee buy link callout (🛒 Official Shopee Buy Link: https://shopee.ph/...) at the bottom of the caption.',
            inputOutputDoc:
                'Input: Affiliate Buy Link ➔ Output: Formatted Buy Link CTA Box.',
            contextPlaceholder: 'e.g. https://shopee.ph/product/12345/67890',
        },
        {
            id: 'fb_publish',
            ...
            docDescription:
                'Executes direct background publishing of the generated caption and media to your connected Facebook Page using official Graph API tokens.',
            inputOutputDoc:
                'Input: Final Post Content + Media ➔ Output: Live Facebook Post ID & Direct Permalink URL.',
    ...
    const rulePresets = [
        {
            ...
            description:
                'Time-appropriate morning/afternoon/evening greeting asking fan engagement questions.',
        ...
        },
        {
            ...
            description:
                'Engages fans with product preference polls and tech upgrade discussions.',
            frequency: 'daily' as const,
            ...
            actionContexts: {
                'Generate Interactive Poll & Question Caption (A/B Voting Hook)':
                    'Compare Mechanical Keyboards vs ANC Headphones',
            },
        },
        {
            ...
            description:
                'Showcases official brand discounts and promo code vouchers.',
            ...
            actionContexts: {
                'Generate Brand Discount & Voucher Showcase Caption':
                    'Use voucher ANKERTECH88 for 40% OFF',
            },
        },
        {
            id: 'preset_flash',
            ...
            description:
                'Extracts trending Shopee deals and broadcasts AI-generated deal hooks.',
            frequency: 'daily' as const,
        ...
        return [
            {
                ...
                actionContexts: {
                    'Generate Dynamic Time-Aware AI Greeting':
                        'Ask community members about their current coffee & WFH workstation setup',
                },
                status: 'active',
            ...
            },
            {
                ...
                lastGeneratedPost: {
                    ...
                    caption:
                        'Quick question for the group! 🔥 Which tech upgrade should we feature in our next community guide tomorrow?\n\n🅰️ ANC Wireless Headphones\n🅱️ RGB Custom Mechanical Keyboards\n\nVote in the comments! 👇',
    ...
    let filteredLogs = $derived(
        logs.filter((log) => {
            if (
                ...
                !log.ruleName
                    .toLowerCase()
                    .includes(logRuleFilter.toLowerCase())
            ) {
                return false;
            }
    ...
    let connectedAccounts = $state<
        { id: string; name: string; platform: string; is_enabled: boolean }[]
    >([]);
    ...
    function getNextRunCountdown(rule: ScheduledRule): {
        text: string;
        detail: string;
    } {
        if (rule.status === 'disabled') {
            return {
                text: '⏸ Rule Paused',
                detail: 'Enable rule to resume schedule',
            };
        }
        ...
        const timeStr =
            rule.times.find((t) => parseTimeToMinutes(t) === nextMinute) || '';
    ...
    function getEvaluatedPromptPreview(): { prompt: string; hints: string[] } {
        ...
        if (!generalPostContext.trim()) {
            hints.push(
                '💡 Add a Global Topic Context (e.g. WFH coffee setup) to anchor captions to your niche.',
            );
        }

        if (!weatherContext.trim()) {
            hints.push(
                '💡 Adding Weather Vibe (e.g. Cozy rainy afternoon) increases viewer relatability.',
            );
        }

        if (!occasionContext.trim()) {
            hints.push(
                '💡 Add Occasion/Sale Context (e.g. 8.8 Payday Sale) to build urgency.',
            );
        }

        if (selectedTones.length === 0) {
            hints.push(
                '💡 Select a copywriting tone like "Taglish 🇵🇭" or "Casual 🤝" for an authentic social voice.',
            );
        }

        if (selectedPersonas.length === 0) {
            hints.push(
                '💡 Select a Creator Persona (e.g. Storyteller Reviewer) to give posts distinct personality.',
            );
        }
        ...
        return {
            ...
            hints:
                hints.length > 0
                    ? hints
                    : [
                          '✨ Prompt parameters are fully evaluated and ready for AI generation!',
                      ],
        };
    }

    function getEventTriggerHintAndPayload(): {
        hint: string;
        ...
        if (
            ...
            newTriggerSource === 'Facebook Page Comments' ||
            newTriggerAction === 'Fan Comment Auto-Reply'
        ) {
            return {
                ...
                examplePayload: JSON.stringify(
                    {
                        ...
                        matched_keyword: 'hm',
                        auto_reply_template:
                            triggerReplyTemplate ||
                            'Hi {user_name}! Here is the buy link: {buy_link}',
                    },
                    null,
                    2,
                ),
                ...
                examplePayload: JSON.stringify(
                    {
                        ...
                        webhook_target:
                            triggerWebhookUrl ||
                            'https://n8n.example.com/webhook/deal-alert',
                        secret_auth: triggerWebhookSecret ? '*******' : 'none',
                        post: {
                            title: 'Baseus 65W GaN Charger',
                            caption:
                                '🔥 Deal alert! Check out Baseus 65W GaN Charger...',
                        },
                    },
                    null,
                    2,
    ...
    function getIntegrationInstructions(): {
        ...
        if (newTriggerSource === 'Inbound Telegram Bot') {
            ...
            return {
                endpoint:
                    'POST http://localhost:8176/api/webhooks/facebook/comment',
                instructions: [
            ...
            return {
                endpoint:
                    'POST http://localhost:8176/api/webhooks/shopee-price-drop',
                instructions: [
    ...
    onMount(() => {
        ...
        const unsubscribeWs = wsClient.subscribe(
            (event: WsTaskProgressEvent) => {
                ...
                if (event.event === 'WORKFLOW_STEP_PROGRESS') {
                    ...
                    logs = [
                        {
                            ...
                            targetPage:
                                resData.target_page || 'Tech Sulit Deals',
                            status: 'SUCCESS',
                            postUrl: liveLink,
                    ...
                    actionNotification =
                        event.message ||
                        `✅ Dynamic AI Workflow Executed & Created Post for "${resData.rule_name || 'Workflow'}"!`;
        ...
        fetch('/settings/social-accounts')
            .then((r) => r.json())
            .catch(() => [])
            .then((res) => {
                const list = Array.isArray(res)
                    ? res
                    : (res as any)?.integrations || [];
                connectedAccounts = list.filter((a: any) => a.is_enabled);
            })
            .catch((err) =>
                console.warn('Could not load connected social accounts:', err),
            );
        ...
        const schedulerInterval = setInterval(() => {
            ...
            for (const rule of scheduledRules) {
                ...
                const timeMinutesList = (rule.times || [])
                    .map(parseTimeToMinutes)
                    .filter((m) => m !== null);
                const matchesTime =
                    timeMinutesList.includes(currentMinuteOfDay);
                ...
                if (
                    ...
                    if (!runningRuleId) {
                        ...
                        console.log(
                            `⏰ [AutoScheduler] Triggering scheduled rule "${rule.name}" at minute ${currentMinuteOfDay}...`,
                        );
                        runScheduleNow(rule);
                    }
                }
    ...
    const categoryOptions = [
        {
            ...
            label: '🤝 Connection & Community (Dynamic Greetings, Polls)',
        },
        {
        ...
        },
        {
            ...
            label: '🛒 Affiliate Deals (Shopee Flash Sales)',
        },
    ];
    ...
    let pageOptions = $derived([
        {
            value: 'Tech Sulit Deals',
            label: '📘 Tech Sulit Deals (Default Facebook Page)',
        },
        ...connectedAccounts
            .filter((a) => a.name !== 'Tech Sulit Deals')
            .map((a) => ({
                value: a.name,
                label: `${a.platform === 'facebook' ? '📘' : a.platform === 'instagram' ? '📸' : '🌐'} ${a.name}`,
            })),
        {
            value: 'All Connected Target Accounts',
            label: '🚀 All Active Connected Accounts (Multi-Publish)',
        },
    ]);
    ...
    const triggerSourceOptions = [
        ...
        {
            value: 'Facebook Page Webhook',
            label: 'Facebook Page Comment Auto-Reply',
        },
    ];
    ...
    let newRuleCategory = $state<
        ...
        | string
    >('Connection & Community');
    let newRuleFrequency = $state<'daily' | 'interval' | 'weekly' | string>(
        'daily',
    );
    let manualTimeSlots = $state<string[]>([
        '08:00 AM',
        '01:00 PM',
        '07:00 PM',
    ]);
    ...
    function applyPreset(preset: (typeof rulePresets)[0]) {
        ...
        actionContexts = preset.actionContexts
            ? ({ ...preset.actionContexts } as Record<string, string>)
            : {};
        testPreviewResult = null;
    ...
    function toggleWorkflowAction(cmdLabel: string) {
        ...
        if (selectedWorkflowActions.includes(cleanLabel)) {
            if (selectedWorkflowActions.length > 1) {
                selectedWorkflowActions = selectedWorkflowActions.filter(
                    (c) => c !== cleanLabel,
                );
            }
        } else {
    ...
    function toggleTriggerStatus(id: string) {
        eventTriggers = eventTriggers.map((t) => {
            if (t.id === id) {
                const nextStatus =
                    t.status === 'active' ? 'disabled' : 'active';
    ...
    function deleteScheduleRule(ruleId: string, ruleName: string) {
        if (
            confirm(
                `Are you sure you want to delete the schedule rule "${ruleName}"?`,
            )
        ) {
    ...
    function handleSaveSchedule() {
        ...
        const fbPublishAction =
            'Publish Finalized Caption to Target Facebook Page';

        if (
            !actionsToSave.some(
                (a) =>
                    a.toLowerCase().includes('publish') ||
                    a.toLowerCase().includes('facebook'),
            )
        ) {
            ...
            scheduledRules = scheduledRules.map((r) => {
                if (r.id === editingRuleId) {
                    const updatedRule: ScheduledRule = {
                        ...
                        times: timesToSave,
                        intervalHours:
                            newRuleFrequency === 'interval'
                                ? selectedInterval
                                : undefined,
                        days:
                            newRuleFrequency === 'weekly'
                                ? selectedDays
                                : undefined,
    ...
    let triggerReplyTemplate = $state(
        'Hi {user_name}! 👋 Thanks for asking! Here is the deal buy link:\n🛒 {buy_link}\n\n#TechSulitDeals',
    );
    let triggerWebhookUrl = $state(
        'https://n8n.example.com/webhook/deal-alert',
    );
    let triggerWebhookSecret = $state('sec_n8n_aiffiliate_2026');
    let triggerVoucherCode = $state('ANKERTECH88');
    let triggerVoucherDiscount = $state(
        '40% OFF with voucher code ANKERTECH88',
    );
    ...
    function deleteTrigger(triggerId: string, triggerName: string) {
        if (
            confirm(
                `Are you sure you want to delete the event trigger "${triggerName}"?`,
            )
        ) {
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 space-y-6">
        <div class="flex flex-col gap-6">
            ...
            {#if actionNotification}
                <div
                    class="fixed top-20 right-4 sm:right-6 max-w-md w-full z-50 p-4 border rounded-2xl text-xs font-semibold flex items-center justify-between shadow-2xl backdrop-blur-2xl animate-slideDown gap-4
			{actionNotificationType === 'warning'
                ...
                >
                    ...
                    <button
                        ...
                        class="text-gray-400 hover:text-white font-bold p-1 cursor-pointer"
                        >✕</button
                    >
                </div>
            {/if}
            ...
            <!-- Header -->
            <div
                class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-900/60 p-6 rounded-2xl border border-gray-800/60 backdrop-blur-xl"
            >
                <div>
                    <h1
                    ...
                    <p class="text-sm text-gray-400 mt-1">
                        Dynamic time-aware AI greetings, community connection,
                        and brand promotion workflows.
                    </p>
                </div>
            ...
            <!-- Sub-Tabs Navigation -->
            <div
                class="flex items-center gap-2 border-b border-gray-800/60 pb-3"
            >
                <button
                    type="button"
				...
				{activeTab === 'scheduled'
                        ? 'bg-transparent text-indigo-300 border border-indigo-500/60 shadow-[0_0_10px_rgba(99,102,241,0.25)] font-semibold'
                ...
                <button
                    ...
                    class="px-4 py-2 rounded-xl text-xs font-medium transition-all flex items-center gap-2 cursor-pointer
				{activeTab === 'event'
                        ? 'bg-transparent text-amber-300 border border-amber-500/60 shadow-[0_0_10px_rgba(245,158,11,0.25)] font-semibold'
                        : 'text-gray-400 hover:text-white border border-transparent'}"
                >
            ...
            {#if activeTab === 'scheduled'}
                ...
                >
                    {#each scheduledRules as rule}
                        ...
                        <div
                            class="bg-gray-900/60 border rounded-2xl p-5 flex flex-col justify-between gap-4 backdrop-blur-xl transition-all
					{isRunning
                                ? 'border-indigo-500 shadow-[0_0_25px_rgba(99,102,241,0.3)] ring-1 ring-indigo-500'
                                : 'border-gray-800/60 hover:border-indigo-500/40 hover:shadow-[0_0_15px_rgba(99,102,241,0.15)]'}
                        ...
                        >
                            <div class="flex items-start justify-between">
                                <div>
                                    <div class="flex items-center gap-2 mb-1">
                                        <span
                                            class="px-2 py-0.5 rounded-md text-[10px] font-semibold border inline-block
									{rule.category === 'Connection & Community'
                                        ...
                                        {#if isRunning}
                                            <span
                                                class="px-2 py-0.5 rounded-md text-[10px] font-bold bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 animate-pulse"
                                            >
                                                ⚡ RUNNING WORKFLOW...
                                            </span>
                                        {/if}
                                ...
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <button
                                        type="button"
                                        onclick={() =>
                                            toggleScheduleStatus(rule.id)}
                                        title={rule.status === 'active'
                                            ? 'Pause rule'
                                            : 'Enable rule'}
                            ...
                            <div class="flex flex-wrap gap-1.5">
                                {#each rule.times as timeSlot}
                                    <span
                                        class="px-2.5 py-1 rounded-lg text-[11px] font-mono font-semibold bg-transparent text-indigo-300 border border-indigo-500/30"
                                    >
                                        {timeSlot}
                                    </span>
                                {/each}
                            ...
                            <div
                                class="flex flex-col gap-1.5 bg-gray-950/70 p-3 rounded-xl border border-gray-800/50"
                            >
                                <div class="flex items-center justify-between">
                                    <span
                                        class="text-[11px] font-semibold text-indigo-400 uppercase tracking-wider"
                                        >Preset Actions Workflow</span
                                    >
                                    {#if isRunning}
                                        <span
                                            class="text-[10px] text-indigo-300 font-mono animate-pulse"
                                            >Step {activeStepIndex + 1} of {rule
                                                .workflowActions.length}</span
                                        >
                                    {/if}
                                </div>
                                ...
                                <div class="flex flex-col gap-1">
                                    {#each rule.workflowActions as actionName, idx}
                                        ...
                                        {@const isCompletedStep =
                                            isRunning && activeStepIndex > idx}
                                        {@const customCtx =
                                            rule.actionContexts?.[actionName]}
                                        <div
                                            class="flex flex-col gap-1 p-1.5 rounded-lg border transition-all
									{isCurrentStep
                                                ? 'bg-indigo-500/20 border-indigo-500/60 text-white font-bold shadow-[0_0_10px_rgba(99,102,241,0.3)] animate-pulse'
                                                : isCompletedStep
                                                  ? 'bg-gray-950/40 border-emerald-500/30 text-emerald-300 font-semibold'
                                                  : 'bg-gray-950/40 border-gray-800/60 text-gray-300'}"
                                        >
                                            <div
                                                class="flex items-start justify-between gap-2 text-xs font-mono min-w-0 max-w-full"
                                            >
                                                <div
                                                    class="flex items-start gap-2 min-w-0 flex-1"
                                                >
                                                    <span
                                                        class="w-4 h-4 rounded-full text-[10px] flex items-center justify-center font-bold border transition-all shrink-0 mt-0.5
												{isCurrentStep
                                                            ? 'bg-indigo-500 border-indigo-400 text-white animate-spin'
                                                            : isCompletedStep
                                                    ...
                                                    <span
                                                        class="break-words whitespace-normal leading-snug flex-1 min-w-0"
                                                        >{actionName}</span
                                                    >
                                                </div>
                                            </div>
                                            ...
                                            {#if customCtx}
                                                <div
                                                    class="text-[10px] text-indigo-300 font-sans italic pl-6 break-words whitespace-normal leading-snug"
                                                >
                                                    💬 Context: "{customCtx}"
                                                </div>
                                            {/if}
                            ...
                            <div
                                class="flex flex-col gap-2 p-3.5 bg-gradient-to-r from-indigo-950/60 to-purple-950/40 rounded-xl border border-indigo-500/40 backdrop-blur-md shadow-inner"
                            >
                                <div class="flex items-center justify-between">
                                    <span
                                        class="text-[10px] font-bold text-indigo-300 uppercase tracking-wider flex items-center gap-1.5 font-mono"
                                    >
                                        <span class="animate-pulse">⏳</span>
                                        <span>Next Scheduled Run</span>
                                    </span>
                                    <span
                                        class="text-[10px] font-bold font-mono px-2 py-0.5 rounded-md border
								{rule.status === 'active'
                                ...
                                <div
                                    class="text-sm font-bold font-mono text-white tracking-wide flex items-center gap-2"
                                >
                                ...
                                <div
                                    class="text-[11px] text-gray-400 font-sans flex items-center justify-between"
                                >
                            ...
                            <button
                                type="button"
                                onclick={() =>
                                    navigateToFilteredLogs(rule.name)}
            ...
            {#if activeTab === 'event'}
                ...
                >
                    {#each eventTriggers as trigger}
                        {@const isTriggerRunning =
                            runningTriggerId === trigger.id}
                        <div
                            class="bg-gray-900/60 border rounded-2xl p-5 flex flex-col justify-between gap-4 backdrop-blur-xl transition-all
					{isTriggerRunning
                                ? 'border-amber-500 shadow-[0_0_25px_rgba(245,158,11,0.3)] ring-1 ring-amber-500'
                                : 'border-gray-800/60 hover:border-amber-500/40 hover:shadow-[0_0_15px_rgba(245,158,11,0.15)]'}
					{trigger.status === 'disabled' && !isTriggerRunning ? 'opacity-50' : ''}"
                        >
                            ...
                            <div
                                class="flex flex-col gap-1.5 text-xs text-gray-400 bg-gray-950/60 p-3 rounded-xl border border-gray-800/40"
                            >
                                <div>
                                    Condition: <span
                                ...
                                <div
                                    class="flex justify-between pt-1 border-t border-gray-800/40"
                                >
                                    <span>Times Fired:</span>
                                    <span class="text-emerald-400 font-bold"
                                        >{trigger.totalFired} times</span
                                    >
                                </div>
                            </div>
                            ...
                            <button
                                type="button"
                                onclick={() =>
                                    navigateToFilteredLogs(trigger.name)}
            ...
            {#if activeTab === 'logs'}
                <div
                    class="bg-gray-900/60 border border-gray-800/60 rounded-2xl p-6 backdrop-blur-xl flex flex-col gap-5"
                >
                    <div
                    ...
                    >
                        <div>
                            ...
                            >
                                ...
                                >
                                <span
                                    class="px-2 py-0.5 rounded-full text-xs font-mono bg-emerald-500/20 text-emerald-300 border border-emerald-500/40"
                                >
                                    {filteredLogs.length} / {logs.length}
                                </span>
                            </h2>
                            <p class="text-xs text-gray-400 mt-0.5">
                                Filter logs by rule name, trigger event,
                                execution type, or status.
                            </p>
                        </div>

                        {#if logRuleFilter}
                            <div
                                class="flex items-center gap-2 bg-indigo-500/15 border border-indigo-500/40 px-3 py-1.5 rounded-xl"
                            >
                                <span
                                    class="text-xs text-indigo-300 font-semibold"
                                    >Filtered for: "{logRuleFilter}"</span
                                >
                                <button
                                    type="button"
                    ...
                    <div
                        class="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3 bg-gray-950/60 p-4 rounded-xl border border-gray-800/60"
                    >
                        ...
                        <div
                            class="flex items-center gap-1 overflow-x-auto pb-1 lg:pb-0"
                        >
                            <span
                                class="text-[11px] text-gray-500 font-semibold mr-1"
                                >Type:</span
                            >
                            <button
                                type="button"
                    ...
                    <div class="overflow-x-auto">
                        {#if filteredLogs.length === 0}
                            <div
                                class="p-8 text-center bg-gray-950/40 rounded-xl border border-gray-800/40 flex flex-col items-center gap-2"
                            >
                                <span class="text-2xl">🔍</span>
                                <span
                                    class="text-sm font-semibold text-gray-300"
                                    >No execution logs match your filter
                                    criteria.</span
                                >
                                <button
                                    type="button"
                        ...
                        {:else}
                            <table class="w-full text-left text-xs font-mono">
                                <thead>
                                    <tr
                                        class="border-b border-gray-800/80 text-gray-400"
                                    >
                                ...
                                <tbody
                                    class="divide-y divide-gray-800/40 text-gray-300"
                                >
                                    {#each filteredLogs as log}
                                        ...
                                        >
											...
											{log.type === 'scheduled'
                                                        ? 'bg-transparent border-indigo-500/40 text-indigo-300'
                                                        : log.type === 'manual'
                                                          ? 'bg-transparent border-purple-500/40 text-purple-300'
                                                          : 'bg-transparent border-amber-500/40 text-amber-300'}"
                                                >
                                                    {log.type.toUpperCase()}
                                                </span>
                                            </td>
                                            <td
                                                class="py-3 px-2 font-semibold text-white"
                                                >{log.ruleName}</td
                                            >
                                            <td
                                                class="py-3 px-2 text-gray-300 truncate max-w-xs"
                                                >{log.dealTitle}</td
                                            >
                                            <td
                                                class="py-3 px-2 text-indigo-400"
                                                >{log.targetPage}</td
                                            >
                                            <td class="py-3 px-2">
                                                <span
                                                    class="px-2 py-0.5 rounded-full text-[10px] font-bold border border-emerald-500/40 text-emerald-400"
                                                >
                                                    {log.status}
                                                </span>
                                            </td>
                                            <td class="py-3 px-2">
                                                ...
                                                {:else}
                                                    <span
                                                        class="text-gray-600 font-sans text-[11px]"
                                                        >—</span
                                                    >
                                                {/if}
                                            </td>
        ...
        {#if selectedPreviewPost}
            ...
            >
                ...
                >
                    <div
                        class="flex items-center justify-between border-b border-gray-800 pb-3"
                    >
                        <div class="flex items-center gap-2">
                            <div
                                class="w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-xs"
                            >
                                f
                            </div>
                            <div>
                                <h3 class="font-bold text-white text-sm">
                                    {selectedPreviewPost.targetPage}
                                </h3>
                                <span class="text-[10px] text-gray-400"
                                    >Published • {selectedPreviewPost.postedAt}</span
                                >
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        <h4 class="font-bold text-indigo-300 text-sm">
                            {selectedPreviewPost.title}
                        </h4>
                        <p
                            class="text-xs text-gray-200 whitespace-pre-wrap leading-relaxed bg-gray-900/80 p-3.5 rounded-xl border border-gray-800/60 font-sans select-text"
                        >
                        ...
                        {#if selectedPreviewPost.image}
                            <div
                                class="rounded-xl overflow-hidden border border-gray-800/60 max-h-72"
                            >
                                <img
                                    src={selectedPreviewPost.image}
                    ...
                    <div
                        class="flex items-center justify-between border-t border-gray-800 pt-3 mt-2 text-xs"
                    >
                        <span
                ...
                >
                    ...
                    >
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <h3 class="font-bold text-white text-sm">
                                    Generated Content Preview ({newRulePage})
                                </h3>
                                <span
                                    class="text-[10px] text-emerald-400 font-mono"
                                    >Test Run Before Saving Rule</span
                                >
                            </div>
                        </div>
                    ...
                    {#if isTestingWorkflow}
                        ...
                        >
                            ...
                            ></div>
                            <span
                                class="text-xs text-indigo-300 font-semibold animate-pulse"
                                >✨ Generating AI content preview...</span
                            >
                        </div>
                    {:else if testPreviewResult}
                        <div class="flex flex-col gap-3">
                            <h4 class="font-bold text-indigo-300 text-sm">
                                {testPreviewResult.title}
                            </h4>
                            <p
                                class="text-xs text-gray-200 whitespace-pre-wrap leading-relaxed bg-gray-900/90 p-4 rounded-xl border border-gray-800/80 font-sans select-text max-h-64 overflow-y-auto"
                            >
                            ...
                            {#if testPreviewResult.image}
                                <div
                                    class="rounded-xl overflow-hidden border border-gray-800/60 max-h-60"
                                >
                                    <img
                                        src={testPreviewResult.image}
                                        alt="Generated Test Media"
                                        class="w-full h-full object-cover"
                                    />
                                </div>
                            {/if}
        ...
        {#if showNewScheduleModal}
            ...
            >
                ...
                >
                    ...
                    <div
                        class="flex flex-col gap-3 border-b border-gray-800 pb-3.5"
                    >
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="font-bold text-white text-lg">
                                    {editingRuleId
                                        ? 'Edit Scheduled Workflow Rule'
                                        : 'Add Scheduled Workflow Rule'}
                                </h3>
                                <p class="text-xs text-gray-400 mt-0.5">
                                    Step {wizardStep} of 3: {wizardStep === 1
                                        ? 'Choose Starting Template'
                                        : wizardStep === 2
                                          ? 'Configure Schedule & Page'
                                          : 'Content Generation Parameters & Preview'}
                                </p>
                            </div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
							...
							{wizardStep === 1
                                    ? 'bg-indigo-500/20 border-indigo-500/60 text-indigo-300 shadow-[0_0_10px_rgba(99,102,241,0.2)]'
                                    : wizardStep > 1
                                      ? 'bg-emerald-500/10 border-emerald-500/40 text-emerald-300'
                                      : 'bg-gray-900 border-gray-800 text-gray-400'}"
                            >
                                <span
                                    class="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold border shrink-0
							{wizardStep === 1
                    ...
                    {#if wizardStep === 1}
                        <div class="flex flex-col gap-4">
                            <p class="text-xs text-gray-400">
                                Select a pre-configured template to auto-fill
                                your workflow, or start from scratch:
                            </p>
                            ...
                            >
                                {#each rulePresets as preset}
                                    ...
                                    >
                                        <div class="flex items-start gap-3">
                                            <span
                                                class="text-2xl p-2 bg-indigo-500/10 rounded-xl border border-indigo-500/30"
                                                >{preset.icon}</span
                                            >
                                            <div class="flex flex-col">
                                                ...
                                                <span
                                                    class="text-[10px] text-indigo-400 font-semibold mt-0.5"
                                        ...
                                        <div
                                            class="flex items-center justify-between pt-2 border-t border-gray-800/60 text-[11px]"
                                        >
                                            <span
                                            ...
                                            >
                                            <span
                                                class="text-indigo-300 font-semibold group-hover:underline"
                                                >Use Template ➔</span
                                            >
                                        </div>
                                    </button>
                                ...
                                >
                                    <div class="flex items-start gap-3">
                                        <span
                                            class="text-2xl p-2 bg-purple-500/10 rounded-xl border border-purple-500/30"
                                            >🛠️</span
                                        >
                                        <div class="flex flex-col">
                                            <h4
                                                class="font-bold text-white text-sm group-hover:text-purple-300 transition-colors"
                                            >
                                                Build Custom Rule from Scratch
                                            </h4>
                                            <span
                                                class="text-[10px] text-purple-400 font-semibold mt-0.5"
                                                >Custom Setup</span
                                            >
                                            <p
                                                class="text-xs text-gray-400 mt-1 leading-relaxed"
                                            >
                                                Configure custom rule names,
                                                frequencies, time slots, and
                                                action step combinations
                                                manually.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        class="flex items-center justify-end pt-2 border-t border-gray-800/60 text-[11px]"
                                    >
                                        <span
                                            class="text-purple-300 font-semibold group-hover:underline"
                                            >Start Blank Setup ➔</span
                                        >
                                    </div>
                                </button>
                            </div>
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="flex flex-col gap-1.5">
                                    ...
                                    <div class="relative">
                                        ...
                                        {#if categoryDropdownOpen}
                                            <div
                                                class="absolute z-50 left-0 right-0 mt-1 bg-gray-900 border border-gray-800 rounded-xl shadow-2xl overflow-hidden animate-fadeIn flex flex-col divide-y divide-gray-800/60"
                                            >
                                ...
                                <div class="flex flex-col gap-1.5">
                                    ...
                                    >
                                        <span
                                            class="text-xs text-gray-400 font-medium"
                                            >Target Connected Social Media
                                            Account</span
                                        >
                                        <a
                                            href="/settings"
                                            class="text-[10px] text-indigo-300 hover:text-indigo-200 hover:underline flex items-center gap-1 font-semibold"
                                        >
                                            <span
                                                >⚙️ Manage Accounts in Settings</span
                                            >
                                        </a>
                                    </div>
                                    <div class="relative">
                            ...
                            <div class="flex flex-col gap-4">
                                {#if newRuleFrequency === 'daily' || newRuleFrequency === 'weekly'}
                                    <div class="flex flex-col gap-2">
                                        <span
                                            class="text-xs text-gray-400 font-medium"
                                            >Scheduled Posting Times</span
                                        >

                                        <div
                                            class="flex flex-wrap items-center gap-2 p-3 bg-gray-900 border border-gray-800 rounded-xl min-h-[64px]"
                                        >
                                            {#if manualTimeSlots.length === 0}
                                                <span
                                                    class="text-xs text-gray-500 italic"
                                                    >No posting times set.
                                                    Select a time below to add.</span
                                                >
                                            {:else}
                                                {#each manualTimeSlots as timeSlot, idx}
                                                    <div
                                                        class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-mono font-semibold bg-transparent text-indigo-300 border border-indigo-500/40 shadow-sm"
                                                    >
                                                        <span>{timeSlot}</span>
                                                        <button
                                                            type="button"
                    ...
                    {#if wizardStep === 3}
                        <div class="flex flex-col gap-4">
                            ...
                            <div
                                class="grid grid-cols-3 gap-2 bg-gray-900/90 p-1.5 rounded-2xl border border-gray-800"
                            >
                                <button
                                    type="button"
                                    onclick={() => (subStep3 = 1)}
                                ...
                                >
                                    <span
                                        >3.2 ⚡ Content Parameters ({selectedWorkflowActions.length})</span
                                    >
                                </button>
                            ...
                            {#if subStep3 === 1}
                                <div
                                    class="flex flex-col gap-4 bg-gray-900/40 p-4 rounded-2xl border border-gray-800 animate-fadeIn"
                                >
                                    <!-- General Post Topic / Niche Context (Optional) -->
                                    <div
                                        class="flex flex-col gap-1.5 p-3 bg-indigo-950/20 border border-indigo-500/30 rounded-xl"
                                    >
                                        <div
                                            class="flex items-center justify-between text-xs"
                                        >
                                            <span
                                                class="text-indigo-300 font-bold flex items-center gap-1"
                                            >
                                                <span
                                                    >📌 General Post Topic /
                                                    Niche Context</span
                                    ...
                                    >
                                        <!-- Weather Context -->
                                        <div
                                            class="flex flex-col gap-1.5 p-3 bg-blue-950/20 border border-blue-500/30 rounded-xl"
                                        >
                                            <div
                                                class="flex items-center justify-between text-xs"
                                            >
                                                <span
                                                    class="text-blue-300 font-bold flex items-center gap-1"
                                                >
                                                    <span
                                                        >🌧️ Weather Awareness
                                                        Context</span
                                        ...
                                        <!-- Occasion Context -->
                                        <div
                                            class="flex flex-col gap-1.5 p-3 bg-amber-950/20 border border-amber-500/30 rounded-xl"
                                        >
                                            <div
                                                class="flex items-center justify-between text-xs"
                                            >
                                                <span
                                                    class="text-amber-300 font-bold flex items-center gap-1"
                                                >
                                                    <span
                                                        >🎉 Occasion / Holiday
                                                        Context</span
                                    ...
                                    <!-- Tone Multi-Select -->
                                    <div
                                        class="flex flex-col gap-2 border-t border-gray-800/60 pt-3"
                                    >
                                        <div
                                            class="flex items-center justify-between"
                                        >
                                            <span
                                                class="text-xs font-bold text-indigo-300 flex items-center gap-1"
                                            >
                                            ...
                                            <span
                                                class="text-[10px] text-gray-500 font-mono"
                                                >{selectedTones.length} Selected</span
                                            >
                                        </div>
                                        <div class="flex flex-wrap gap-2">
                                            {#each availableTones as t}
												...
												{isSelectedTone
                                                        ? 'bg-indigo-500/25 border-indigo-500/60 text-indigo-200 shadow-[0_0_10px_rgba(99,102,241,0.25)]'
                                                        : 'bg-gray-950 border-gray-800 text-gray-400 hover:border-gray-700 hover:text-white'}"
                                                >
                                                    <span>{t.label}</span>
                                                    {#if isSelectedTone}<span
                                                            class="text-indigo-400 font-bold"
                                                            >✓</span
                                                        >{/if}
                                                </button>
                                    ...
                                    <div
                                        class="flex flex-col gap-2 pt-3 border-t border-gray-800/60"
                                    >
                                        <div
                                            class="flex items-center justify-between"
                                        >
                                            <span
                                                class="text-xs font-bold text-amber-300 flex items-center gap-1"
                                            >
                                            ...
                                            <span
                                                class="text-[10px] text-gray-500 font-mono"
                                                >{selectedPersonas.length} Selected</span
                                            >
                                        </div>
                                        <div class="flex flex-wrap gap-2">
                                            {#each availablePersonas as p}
                                                {@const isSelectedPersona =
                                                    selectedPersonas.includes(
                                                        p.id,
                                                    )}
                                                <button
                                                    type="button"
                                                    ...
                                                    class="px-3 py-1.5 rounded-xl text-xs font-semibold border transition-all cursor-pointer flex items-center gap-1.5
												{isSelectedPersona
                                                        ? 'bg-amber-500/25 border-amber-500/60 text-amber-200 shadow-[0_0_10px_rgba(245,158,11,0.25)]'
                                                        : 'bg-gray-950 border-gray-800 text-gray-400 hover:border-gray-700 hover:text-white'}"
                                                >
                                                    <span>{p.label}</span>
                                                    {#if isSelectedPersona}<span
                                    ...
                                    <div
                                        class="flex flex-col gap-1.5 pt-3 border-t border-gray-800/60"
                                    >
                                        <span
                                            class="text-xs font-bold text-gray-300 flex items-center gap-1"
                                        >
                                            <span
                                                >✍️ Custom Creator Persona /
                                                Brand Voice</span
                                            >
                                            <span
                            ...
                            {#if subStep3 === 2}
                                <div
                                    class="flex flex-col gap-3.5 bg-gray-900/40 p-4 rounded-2xl border border-gray-800 animate-fadeIn"
                                >
                                    <div
                                        class="flex items-center justify-between"
                                    >
                                        ...
                                        >
                                        <span
                                            class="text-[11px] text-indigo-300 font-semibold"
                                            >{selectedWorkflowActions.length} Selected</span
                                        >
                                    </div>

                                    <div
                                        class="flex flex-col gap-2 max-h-[380px] overflow-y-auto pr-1"
                                    >
                                        {#each presetWorkflows as wf}
                                            ...
                                            {@const isSelected =
                                                selectedWorkflowActions.includes(
                                                    cleanName,
                                                )}
                                            {@const isDocExpanded =
                                                expandedDocActionId === wf.id}
                                            {@const isAffiliateAction =
                                                wf.id.startsWith('affiliate')}

                                            {#if wf.id === 'affiliate_extract'}
                                                <div
                                                    class="my-1.5 pt-2 border-t border-gray-800 flex items-center justify-between text-[11px]"
                                                >
                                                    <span
                                                        class="font-bold text-amber-400 uppercase tracking-wider flex items-center gap-1"
                                                    >
                                                        <span
                                                            >🛒 Shopee Affiliate
                                                            Specific Actions</span
                                                        >
                                                    </span>
                                                    <span
                                                        class="text-[10px] text-gray-500 font-mono"
                                                        >Affiliate Engine</span
                                                    >
                                                </div>
                                            {/if}
										...
										{isSelected
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <span
                                                            class="group-hover:text-white transition-colors {isSelected
                                                                ? isAffiliateAction
                                                        ...
                                                        >
                                                        <span
                                                            class="text-xs px-1.5 py-0.5 rounded-md border text-[10px] font-bold
													{isSelected
                                                                ? isAffiliateAction
                                                ...
                                                {#if isDocExpanded}
                                                    <div
                                                        class="p-3 bg-gray-950/90 rounded-xl border border-indigo-500/30 text-xs flex flex-col gap-1.5 animate-fadeIn"
                                                    >
                                                        <div
                                                            class="font-bold text-white text-[11px]"
                                                        >
                                                            📖 {wf.title}
                                                        </div>
                                                        <p
                                                            class="text-[11px] text-gray-300 leading-relaxed font-sans"
                                                        >
                                                            {wf.docDescription}
                                                        </p>
                                                        <div
                                                            class="text-[10px] text-indigo-300 font-mono bg-indigo-500/10 p-2 rounded-lg border border-indigo-500/20"
                                                        >
                                                            {wf.inputOutputDoc}
                                                        </div>
                                                    </div>
                                                ...
                                                {#if isSelected}
                                                    <div
                                                        class="flex flex-col gap-1 mt-1 pt-2 border-t border-indigo-500/20"
                                                    >
                                                        <div
                                                        ...
                                                        >
                                                            <span
                                                                ...
                                                                Context /
                                                                Instructions <span
                                                                    class="text-gray-500 font-normal text-[10px]"
                                                                    >(Optional)</span
                                                                >:</span
                                                            >
                                                        </div>
                                                        <input
                                                            ...
                                                            placeholder={wf.contextPlaceholder
                                                                ? `${wf.contextPlaceholder}`
                                    ...
                                    <div
                                        class="flex flex-col gap-1.5 p-3 bg-gray-950 rounded-xl border border-gray-800"
                                    >
                                        <div
                                            class="flex items-center justify-between text-xs"
                                        >
                                ...
                                >
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-400">
                                                Review settings, generate
                                                preview, or save rule.
                                            </p>
                                        </div>
                                        ...
                                        <button
                                            type="button"
                                            onclick={testGeneratePreview}
                                            disabled={selectedWorkflowActions.length ===
                                                0}
                                    ...
                                    >
                                        <div
                                            class="p-3 bg-gray-950 rounded-xl border border-gray-800/80 flex flex-col gap-1.5"
                                        >
                                            <span
                                                class="text-indigo-300 font-bold"
                                                >⚙️ Schedule Details</span
                                            >
                                            <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="text-indigo-300 font-bold"
                                                    >{selectedWorkflowActions.length}
                                                    Steps</span
                                                >
                                            </div>
                                            {#if customPersonaInput.trim()}
                                                <div
                                                    class="text-[11px] text-gray-400 italic pt-1 border-t border-gray-800"
                                                >
                                                    "Voice: {customPersonaInput}"
                                                </div>
                                            {/if}
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        class="flex flex-col gap-2 p-3.5 bg-indigo-950/40 border border-indigo-500/40 rounded-xl"
                                    >
                                        <div
                                            class="flex items-center justify-between"
                                        >
                                            <span
                                                class="text-xs font-bold text-indigo-300 flex items-center gap-1.5 font-mono"
                                            >
                                                <span
                                                    >🧠 Evaluated AI Prompt
                                                    Payload</span
                                            ...
                                            <span
                                                ...
                                                >Evaluated before sending to AI
                                                Engine</span
                                            >
                                        </div>

                                        <div
                                            class="p-2.5 bg-gray-950 rounded-lg border border-gray-800 text-[11px] font-mono text-gray-300 whitespace-pre-wrap leading-relaxed max-h-36 overflow-y-auto"
                                        >
                                            {evalData.prompt}
                                        </div>
                                        ...
                                        <!-- Optimization Hints -->
                                        <div
                                            class="flex flex-col gap-1 pt-1.5 border-t border-indigo-500/20"
                                        >
                                            <span
                                                class="text-[10px] font-bold text-amber-400 uppercase tracking-wider font-mono"
                                                >💡 Prompt Evaluation & Hints:</span
                                            >
                                            {#each evalData.hints as hint}
                                                <div
                                                    class="text-[11px] text-gray-300 font-sans leading-snug"
                                                >
                                                    {hint}
                                                </div>
                                            {/each}
                                    ...
                                    <div
                                        class="flex items-center justify-between pt-3 border-t border-gray-800"
                                    >
                                        <button
                                            type="button"
                                            onclick={() => (subStep3 = 2)}
                    ...
                    <div
                        class="flex items-center justify-between mt-4 pt-3 border-t border-gray-800"
                    >
                        <div>
                            {#if wizardStep > 1}
                                <button
                                    type="button"
                                    onclick={() =>
                                        (wizardStep = (wizardStep - 1) as any)}
            ...
            >
                ...
                >
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label
                            class="text-xs text-gray-400 font-medium"
                            for="trigger_name">Trigger Name</label
                        >
                        <input
                            id="trigger_name"
                            type="text"
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            ...
                            >
                                <span
                                    >{triggerSourceOptions.find(
                                        (o) => o.value === newTriggerSource,
                                    )?.label || newTriggerSource}</span
                                >
                                <span class="text-[10px] text-gray-400"
                                    >{triggerSourceDropdownOpen
                                        ? '▲'
                            ...
                            {#if triggerSourceDropdownOpen}
                                <div
                                    class="absolute z-50 left-0 right-0 mt-1 bg-gray-900 border border-gray-800 rounded-xl shadow-2xl overflow-hidden animate-fadeIn flex flex-col divide-y divide-gray-800/60 max-h-48 overflow-y-auto"
                                >
                                    {#each triggerSourceOptions as opt}
                                        <button
                                            type="button"
                                            onclick={() => {
                                                newTriggerSource = opt.value;
                                                triggerSourceDropdownOpen = false;
                                            }}
                                            class="px-3 py-2.5 text-xs text-left transition-colors flex items-center justify-between cursor-pointer
										{newTriggerSource === opt.value
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label
                            class="text-xs text-gray-400 font-medium"
                            for="trigger_condition">Trigger Condition</label
                        >
                        <input
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label
                            class="text-xs text-gray-400 font-medium"
                            for="trigger_target_page">Target Social Page</label
                        >
                        <select
                        ...
                        >
                            <option value="Tech Sulit Deals"
                                >Tech Sulit Deals (Facebook Page)</option
                            >
                            {#each connectedAccounts as acc}
                                {#if acc.name !== 'Tech Sulit Deals'}
                                    <option value={acc.name}
                                        >{acc.name} ({acc.platform})</option
                                    >
                                {/if}
                            {/each}
                        </select>
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label
                            class="text-xs text-gray-400 font-medium"
                            for="trigger_action_pipeline"
                            >Trigger Action Pipeline</label
                        >
                        <select
                            ...
                            class="bg-gray-900 border border-gray-800 rounded-xl p-3 text-xs text-white outline-none focus:border-amber-500 cursor-pointer"
                        >
                            <option value="Auto Extract & Instant Publish"
                                >⚡ Auto Extract & Instant Publish to Facebook</option
                            >
                            <option value="Fan Comment Auto-Reply"
                                >💬 Fan Comment Auto-Reply with Buy Link</option
                            >
                            <option value="n8n Outbound Webhook Dispatch"
                                >🌐 Dispatch Outbound Webhook to n8n</option
                            >
                            <option value="Voucher Code Expiry Alert"
                                >🎟️ Voucher Code Expiry Warning</option
                            >
                        </select>
                    </div>
                    ...
                    {#if newTriggerAction === 'Auto Extract & Instant Publish'}
                        <div
                            class="flex flex-col gap-3 p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl animate-fadeIn"
                        >
                            <span
                                class="text-[11px] font-bold text-amber-300 uppercase tracking-wider flex items-center gap-1"
                            >
                            ...
                            <div class="flex flex-col gap-1">
                                <label
                                    class="text-[11px] text-gray-300 font-medium"
                                    for="trigger_shopee_url"
                                    >Default Shopee Product URL</label
                                >
                                <input
                    ...
                    {:else if newTriggerAction === 'Fan Comment Auto-Reply'}
                        <div
                            class="flex flex-col gap-3 p-3 bg-purple-500/10 border border-purple-500/30 rounded-xl animate-fadeIn"
                        >
                            <span
                                class="text-[11px] font-bold text-purple-300 uppercase tracking-wider flex items-center gap-1"
                            >
                            ...
                            <div class="flex flex-col gap-1">
                                <label
                                    class="text-[11px] text-gray-300 font-medium"
                                    for="trigger_reply_template"
                                    >Auto-Reply Message Template</label
                                >
                                <textarea
                    ...
                    {:else if newTriggerAction === 'n8n Outbound Webhook Dispatch'}
                        <div
                            class="flex flex-col gap-3 p-3 bg-blue-500/10 border border-blue-500/30 rounded-xl animate-fadeIn"
                        >
                            <span
                                class="text-[11px] font-bold text-blue-300 uppercase tracking-wider flex items-center gap-1"
                            >
                            ...
                            <div class="flex flex-col gap-1">
                                <label
                                    class="text-[11px] text-gray-300 font-medium"
                                    for="trigger_webhook_url"
                                    >n8n / Receiver Webhook HTTP URL</label
                                >
                                <input
                            ...
                            <div class="flex flex-col gap-1">
                                <label
                                    class="text-[11px] text-gray-300 font-medium"
                                    for="trigger_webhook_secret"
                                    >Webhook Secret Auth Token</label
                                >
                                <input
                    ...
                    {:else if newTriggerAction === 'Voucher Code Expiry Alert'}
                        <div
                            class="flex flex-col gap-3 p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl animate-fadeIn"
                        >
                            <span
                                class="text-[11px] font-bold text-emerald-300 uppercase tracking-wider flex items-center gap-1"
                            >
                            ...
                            <div class="flex flex-col gap-1">
                                <label
                                    class="text-[11px] text-gray-300 font-medium"
                                    for="trigger_voucher_discount"
                                    >Discount Offer Description</label
                                >
                                <input
                    ...
                    <div
                        class="flex flex-col gap-2 p-3 bg-gray-900 border border-gray-800 rounded-xl"
                    >
                        <div class="flex items-center justify-between">
                            <span
                                class="text-xs font-bold text-amber-300 flex items-center gap-1.5 font-mono"
                            >
                                <span
                                    >🧪 Sample Event Input Payload (Evaluated by
                                    AI)</span
                                >
                            </span>
                        ...
                        <pre
                            class="p-2.5 bg-gray-950 rounded-lg border border-gray-800/80 text-[10px] font-mono text-amber-200/90 whitespace-pre-wrap leading-relaxed max-h-32 overflow-y-auto">{triggerInfo.examplePayload}</pre>

                        <div
                            class="text-[11px] text-gray-300 font-sans leading-snug pt-1 border-t border-gray-800"
                        >
                            {triggerInfo.hint}
                        </div>
                    </div>
                    ...
                    <div
                        class="flex flex-col gap-2 p-3 bg-amber-950/30 border border-amber-500/40 rounded-xl"
                    >
                        <div class="flex items-center justify-between">
                            <span
                                class="text-xs font-bold text-amber-300 flex items-center gap-1.5 font-mono"
                        ...
                        <div
                            class="p-2 bg-gray-950 rounded-lg border border-gray-800 text-[10px] font-mono text-emerald-300 font-semibold truncate"
                        >
                            Endpoint: {setupInfo.endpoint}
                        </div>

                        <div
                            class="flex flex-col gap-1 text-[11px] text-gray-300 font-sans leading-snug"
                        >
                    ...
                    <div
                        class="flex justify-end gap-2 mt-4 pt-3 border-t border-gray-800"
                    >
                        <button
                            type="button"
                            onclick={() => (showNewTriggerModal = false)}

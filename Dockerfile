...
CMD ["sh", "-c", "php artisan storage:link || true && php artisan migrate --force && npx concurrently 'php artisan serve --host=0.0.0.0 --port=8000' 'npm run dev -- --host 0.0.0.0 --port 5173'"]
